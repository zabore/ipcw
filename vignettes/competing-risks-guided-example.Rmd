...
The `fg_split_cr()` function splits the data into event-specific datasets, and the `add_fg_weights_cr()` function computes weights for Fine-Gray regression. The `fg_weighted_cr()` function fits a weighted Fine-Gray model.
