...
![](reference/figures/README-se-example-1.png)

See
[`vignette("single-event-guided-example")`](https://www.emilyzabor.com/ipcw/articles/single-event-guided-example.md)
for the full walkthrough, including bootstrap confidence intervals and
Cox regression.
